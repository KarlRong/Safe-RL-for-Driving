...
public:
    FMTreeLTL(const std::vector<double> &s_init, const std::vector<double> &s_goal, int N, std::shared_ptr<WorldLTL> world, bool draw = false) : world_(world), s_init_(s_init),
                                                                                                                                                 s_goal_(s_goal),
                                                                                                                                                 N_(N),
