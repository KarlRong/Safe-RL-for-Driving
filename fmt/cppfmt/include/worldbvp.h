...
{
public:
    WorldBvp(std::vector<std::vector<double>> &objShapes, double xmin, double xmax, double ymin, double ymax, double vxmin, double vxmax, double vymin, double vymax, double tmin, double tmax,double w = 0.01, double h = 0.01) : objShapes_(objShapes),
                                                                                                                                                                                                       xmin_(xmin),
                                                                                                                                                                                                       xmax_(xmax),
                                                                                                                                                                                                       ymin_(ymin),
                                                                                                                                                                                                       ymax_(ymax),
                                                                                                                                                                                                       ...
                                                                                                                                                                                                       h_(h)
    {
        ...
        for (const auto &objShape : objShapes_)
        {
            ...
            std::shared_ptr<fcl::CollisionGeometryd> objBox = std::shared_ptr<fcl::CollisionGeometryd>(new fcl::Box<double>(objShape[2], objShape[3], 1)); // 長寬高
